...
* @date 03-июн-2008
* @brief сессии лички
* @details описан класс предсталяющий один сеанс лички
*}
//******************************************************************************
unit session;
...
type
  /// сеанс лички
  {*
    предсталяет уникальный сеанс лички
  *}
  TUserSession = class
  public
    /// cid того, с кем общаемся
    cid: WideString;
    /// вся информация о нем
    params: TStringList;
  ...
  private
    ...
    ///отсылка сообщения через заданный промежуток времени
...
* @param msg WideString const текст входящей лички
* @result None
...
* @result WideString фраза с подставленными значениями
