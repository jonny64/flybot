...
const string SettingsManager::settingTags[] =
{
	...
	// ApexDC++
	"BetaUser", "BetaPass", "AuthPass", "SkiplistShare", "HighPrioFiles", "LowPrioFiles", "SecondaryAwayMsg", "ProtectedPrefixes",
	"WMPFormat", "iTunesFromat", "MPCFormat", "PopupFont", "PopupTitleFont", "PopupFile", "AntiVirPath", "AntiVirParams",
	"SENTRY",
	...
	"StripTopic", "TbImageSize", "TbImageSizeHot", "OpenCdmDebug", "HubThreshold",
	"PreviewPm", "PopupTime", "AwayThrottle", "AwayStart", "AwayEnd", "OdcStyleBumped", "TopSpeed",
	"StealthyStyle", "IpInChat", "CountryInChat", "TopUpSpeed", "Broadcast", "SettingsState", "Page", "ChatBufferSize",
	"EnableHubTopic", "MediaPlayer", "ProtFavs", "MaxMsgLength", "PopupBackColor", "PopupTextColor",
	"PopupTitleTextColor", "OpenLogsInternal", "NoEmotesLinks", "GlobalHubFrameConf", "UseAntiVir", 
	"IgnoreUseRegExpOrWc", "StealthyIndicateSpeeds", "OldTrayBehav", "OldNamingStyle", "OldIconsMode", "ColourDupe",
	"NoTigerTreeHashCheat", "OldClientRaw", "DeleteChecked", "Topmost", "LockToolbars", "AutoCompleteSearch", "KeepDLHistory", "KeepULHistory",
...
SettingsManager::SettingsManager()
{
	...
	setDefault(INCOMING_CONNECTIONS, INCOMING_FIREWALL_NAT);
	...
	setDefault(HUBLIST_SERVERS, "http://dchublist.com.nyud.net/hublist.xml.bz2;http://adchublist.com.nyud.net/hublist.xml.bz2;http://hublist.hubtracker.com.nyud.net/hublist.xml.bz2");
	...
	setDefault(AUTO_COMPLETE_SEARCH, false);
	...
	setDefault(CHECK_CLIENT_BEFORE_FILELIST, true);
	...
	setDefault(DONT_SHARE_EMPTY_DIRS, true);
	...
	setDefault(UPLOAD_BAR_COLOR, RGB(145, 0, 7));
	setDefault(DOWNLOAD_BAR_COLOR, RGB(0, 145, 7));
...
void SettingsManager::load(string const& aFileName)
{
	...
	if(SETTING(INCOMING_CONNECTIONS) == INCOMING_DIRECT) {
		...
		set(TLS_PORT, (int)Util::rand(1025, 8000));
	}
}
...
void SettingsManager::save(string const& aFileName) {
	...
	{
		if(i == CONFIG_VERSION) {
			xml.addTag(settingTags[i], BUILDID);
