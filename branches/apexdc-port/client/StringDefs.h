...
enum Strings { // @DontAdd
	...
	LIMIT, // "Upload Limit"
	LISTENER_FAILED, // "Listening socket failed (you need to restart ApexDC++): "
	...
	SETCZDC_NOTE_DOWNLOAD, // "* If upload limit is set, download limit is max 7 × upload limit!"
	...
	SETCZDC_REMOVE_FORBIDDEN, // "Remove Forbidden (Unfinished Kazaa, Win MX, GetRight, eMule, ApexDC++)"
	...
	SETCZDC_WINAMP, // "Media toolbar && spam settings"
	SETTINGS, // "Settings"
	...
	SETTINGS_DISPLAY_DC_UPDATE, // "Don't announce new ApexDC++ versions (version.xml is still downloaded)"
	...
	CHECKER_CLIENT_BEFORE_FILELIST, // "Detect client before checking filelist"
	...
	IPGUATD_VALUES_REQ, // "All values are mandatory!"
	IPGUARD_INVALID_START, // "Invalid start address supplied!"
	IPGUARD_INVALID_END, // "Invalid end address supplied!"
	IPGUARD_INVALID_RANGE, // "Invalid range supplied!"
	IPGUARD_RANGE_EXISTS, // "Range with this name already exists!"
	IPGUARD_ENABLE, // "Enable IPGuard"
	IPGUARD_INTRO, // "IPGuard is intended to be used for blocking malicious ip ranges only, and it is not by any means a substitute for firewall or other internet security software!\r\n\r\nWarning: IPGuard affects all connections in ApexDC++"
	START, // "Start"
	END, // "End"
	ALLOW, // "Allow"
	DENY, // "Deny"
	...
	PLUGINS_NO_CONFIG, // "This plugin requires no configuration"
	...
	UPDATER_RESTART, // "Update installation successfull, would you like to restart ApexDC++ now to complete the update proccess?"
	UPDATER_RESTART2, // "Previous update proccess has not been completed yet, would you like to restart ApexDC++ now in order to update?"
	UPDATER_FAILED, // "Automatic update failed:"
	UPDATER_END, // "Your version of ApexDC++ has been updated successfully!"
	LAST // @DontAdd
};
