...
public:
	...
	UserCommand(int aId, int aType, int aCtx, Flags::MaskType aFlags, const string& aName, const string& aCommand, const string& aHub) throw() 
...
/**
 * @file
 * $Id: UserCommand.h 373 2008-02-06 17:23:49Z bigmuscle $
 */
