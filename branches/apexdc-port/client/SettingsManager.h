...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		UPDATE_URL, SOUND_TTH, SOUND_EXC, SOUND_HUBCON,  SOUND_HUBDISCON, SOUND_FAVUSER, SOUND_TYPING_NOTIFY,
 		WEBSERVER_FORMAT, WEBSERVER_USER, WEBSERVER_PASS, LOG_FILE_MAIN_CHAT, 
		...
		// ApexDC++
		BETAUSR, BETAPASS, PASSWORD, SKIPLIST_SHARE, HIGH_PRIO_FILES, LOW_PRIO_FILES, SECONDARY_AWAY_MESSAGE, PROT_USERS,
		WMP_FORMAT, ITUNES_FORMAT, MPLAYERC_FORMAT, POPUP_FONT, POPUP_TITLE_FONT, POPUPFILE, ANTIVIR_PATH, ANTIVIR_PARAMS,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		USE_EXTENSION_DOWNTO, ERROR_COLOR, EXPAND_QUEUE, TRANSFER_SPLIT_SIZE, 
		...
		FIREBALL_COLOR, SERVER_COLOR, PASIVE_COLOR, OP_COLOR, 
		...
		FILTER_ENTER, SORT_FAVUSERS_FIRST, SHOW_SHELL_MENU, SEND_BLOOM, OVERLAP_CHUNKS,

		// ApexDC++
		SHOW_DESCRIPTION_SLOTS, SHOW_DESCRIPTION_LIMIT, PROTECT_TRAY, PROTECT_START, PROTECT_CLOSE,
		STRIP_TOPIC, TB_IMAGE_SIZE, TB_IMAGE_SIZE_HOT, OPEN_CDMDEBUG, USER_THERSHOLD,
		PM_PREVIEW, POPUP_TIME, AWAY_TIME_THROTTLE, AWAY_START, AWAY_END, PROGRESSBAR_ODC_BUMPED, TOP_SPEED,
		STEALTHY_STYLE, IP_IN_CHAT, COUNTRY_IN_CHAT, TOP_UP_SPEED, BROADCAST, SETTINGS_STATE, PAGE, CHATBUFFERSIZE,
		ENABLE_HUBTOPIC, MEDIA_PLAYER, PROT_FAVS, MAX_MSG_LENGTH, POPUP_BACKCOLOR, POPUP_TEXTCOLOR,
		POPUP_TITLE_TEXTCOLOR, OPEN_LOGS_INTERNAL, NO_EMOTES_LINKS, GLOBAL_HUBFRAME_CONF, USE_ANTIVIR,
		IGNORE_USE_REGEXP_OR_WC, STEALTHY_INDICATE_SPEEDS, OLD_TRAY_BEHAV, OLD_NAMING_STYLE, OLD_ICONS_MODE, COLOUR_DUPE,
		NO_TTH_CHEAT, OLD_CLIENT_RAW, DELETE_CHECKED, TOPMOST, LOCK_TOOLBARS, AUTO_COMPLETE_SEARCH, KEEP_DL_HISTORY, KEEP_UL_HISTORY,
	...
	void set(IntSetting key, int value) {
		...
		if((key == POPUP_TIME) && (value < 1)) {
			value = 1;
		} else if((key == POPUP_TIME) && (value > 15)) {
			value = 15;
		}

		if((key == MAX_MSG_LENGTH) && (value < 1)) {
			value = 1;
		} else if((key == MAX_MSG_LENGTH) && (value > 250)) {
			value = 250;
		}
...
/**
 * @file
 * $Id: SettingsManager.h 382 2008-03-09 10:40:22Z BigMuscle $
 */
