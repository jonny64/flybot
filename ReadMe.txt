...
Version: 17-Jun-2009 (rev. #5 for CodeProject)

Verpatch is a command line tool for adding and editing the version information
on Windows executable files (applications, DLLs, kernel drivers)
...
Verpatch replaces the version number in the file version info resource
...
=========================
 ...
 - Currenly implemented only US English and Language Neutral Unicode version resources.
   ...
   Version info in other languages will be erroneously rewritten as English.- TO DO
   
   Also, a second (language neutral) version resource may be added to a file
...
Source code 
============
The source is provided as a Visual C++ 2008 Express project.
